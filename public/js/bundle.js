...
exports.somedata = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(t, el) {
    var res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 3:
            ...
            return _context6.abrupt("return", res.data.allcandidates);
          ...
          case 8:
            ...
            (0, _alert.alert)(_context6.t0.response.data.message, 'error');
...
if (signup) {
  ...
  var t = document.querySelector('#signup_role');
  t.addEventListener("change", /*#__PURE__*/function () {
            ...
            case 0:
              ...
              if (val == "candidate") {
                ...
                for (i = 0; i < ans.length; i++) {
                  temp = temp + "<option value=".concat(ans[i]._id, "> ").concat(ans[i].name, "</option>");
                }
  ...
  document.querySelector("#submit_details").addEventListener('click', function (e) {
    e.preventDefault();
    ...
    var worksfor = document.querySelector('#signup_worksfor');
    if (worksfor) worksfor = worksfor.value;
    var post = document.querySelector('#signup_post');
    if (post) post = post.value;
...
if (savePersonalDetails) {
  document.querySelector(".submit_info").addEventListener('click', function (e) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "34974" + '/');
